...
//      }
  ...
  public void importFiles(String path, String pattern, ArrayList<String> files, ArrayList<String> keys, ArrayList<String> fails, ArrayList<String> dels) {
    ...
    if(pattern != null && !pattern.isEmpty()) {
      ...
      ArrayList<String> subsetFails = matchPattern(path,fails,pattern); //New fails ArrayList after matching pattern of choice
      keys.retainAll(subsetFails); //Subset keys based on subsetFails
    }
